...
self.addEventListener('fetch', e => {
  ...
  if (u.hostname.includes('sentinel-cogs') || u.hostname.includes('earth-search') || u.hostname.includes('emodnet') ||
      u.hostname.includes('arcgisonline') || u.hostname.includes('openstreetmap') || u.pathname.endsWith('.tif')) return;
