...
<style>
  ...
  *{box-sizing:border-box;-webkit-tap-highlight-color:transparent}
  ...
  .grab{width:36px;height:4px;border-radius:2px;background:#2b4056;margin:9px auto 4px}
  .sheetH{display:flex;justify-content:space-between;align-items:center;position:sticky;top:0;background:var(--card2);padding:6px 0 12px;z-index:2}
  .sheetH b{color:var(--ink);font-size:15px;font-weight:600}
  #sheetClose{background:none;border:none;color:var(--mut);font-size:20px;cursor:pointer;line-height:1}
  .seg{display:flex;gap:4px;margin:2px 0 4px;background:rgba(255,255,255,.04);border-radius:12px;padding:3px}
  ...
  #sdbDate{flex:1;background:rgba(255,255,255,.05);color:#fff;border:1px solid var(--bd);border-radius:9px;padding:8px;font-size:12px}
  .acts{display:grid;grid-template-columns:1fr;gap:6px;margin-top:8px}
  .act{padding:12px 14px;border-radius:11px;border:1px solid transparent;background:rgba(255,255,255,.045);color:var(--ink);font-weight:600;font-size:13px;cursor:pointer;text-align:left;transition:.12s}
  .act:active{background:rgba(22,224,255,.13)}
  .foot2{display:flex;gap:8px;margin-top:16px}
  .foot2 a{flex:1;text-align:center;text-decoration:none;font-size:12.5px;border-radius:11px;padding:11px;border:1px solid var(--bd)}
